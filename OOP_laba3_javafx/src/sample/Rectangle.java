...
public class Rectangle{
    private  final Point rec_start_point;
    ...
    public Rectangle()
    {
        ...
        rec_start_point = new Point(x, y);
        this.width = (int) (Math.random() * (1300 - x));
        this.height = (int) (Math.random() * (880 - y));
    ...
    public Rectangle(Point rec_start_point, int width, int height, Color rec_color)
    {
        this.rec_start_point = rec_start_point;
        this.width = width;
        this.height = height;
